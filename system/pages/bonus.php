...
<form data-section="13" action="index.php?page=posttest" method="post">
<div id="progress">Test 13/13</div>
<div id="meta">
...
<?php
	...
	$t_section = $testcases_rand[$_SESSION["user_id"]][0];

	$candidate = $testcases[($subgroup+1)][($t_section+1)][0];
	$perspectivechange = $testcases[($subgroup+1)][($t_section+1)][1];
	$rand = array(0,1,3,6,7,17,2,4,9,8,16,14,5,11,10,15,13,12);
